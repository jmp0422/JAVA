...
public class Inet {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("내pc명 : " + localIP.getHostName());
            System.out.println("내주소 : " + localIP.getHostAddress());

            InetAddress naverIP = InetAddress.getByName("www.naver.com"); // dns주소를 활용해서 ip 주소 변환

            System.out.println("네이버서버명 : " + naverIP.getHostName());
            System.out.println("네이버서버 : " + naverIP.getHostAddress());
